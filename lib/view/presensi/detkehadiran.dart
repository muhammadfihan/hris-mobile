...
class DetKehadiran extends StatefulWidget {
  const DetKehadiran({
    Key? key,
    required this.id,
  }) : super(key: key);
  ...
  @override
  State<DetKehadiran> createState() => _DetKehadiranState();
}

class _DetKehadiranState extends State<DetKehadiran> {
  ...
  Future getAbsen() async {
    ...
    final response = await http.get(
        Uri.parse(baseURL + 'detailabsenpegmobile/${widget.id}'),
        headers: {
